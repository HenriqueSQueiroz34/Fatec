Ex01.py Fazer uma aplicação, console, que gerencie a figura abaixo:
...
vez no cruzamento.
Ex02.py Quatro pessoas caminham, cada uma em um corredor diferente. Os 4 corredores terminam
...
o sapo chegou.
Ex04.py Você foi contratado para automatizar um treino de Fórmula 1. As regras estabelecidas pela
