Ex01: Elaborar um programa que apresente o valor da conversão em real (R$) de um valor lido em
dólar (US$). O programa deve considerar a cotação do dólar em R$5 (Usar apenas números
inteiros).

Ex02: Ler dois valores para 2 registradores e efetuar a troca dos valores de forma que o valor do
...
Ex03: Crie um programa que lê o mês e o ano de nascimento de uma pessoa e o mês e ano atual.
Calcule e mostre qual é: a idade da pessoa em meses.

Ex04: O proprietário da empresa ABC LTDA precisa de um programa de computador para calcular o
...
Ex05: Escreva um programa que pergunte os coeficientes de uma equação de segundo grau (A, B e
C) e:
...
Ex06: Escreva um programa que pergunte dois números e indique se são iguais ou diferentes. Caso
sejam diferentes, mostre o maior e o menor (nesta ordem).

Ex07: Ler um número inteiro e imprimir a saída da seguinte forma:
CENTENA = x
DEZENA = y
UNIDADE = z
Exemplo:
...
Ex08: Escreva um algoritmo que leia (em números inteiros) o valor da compra de um produto da Loja
